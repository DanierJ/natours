...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZGFuaWVyLW1hcnRpbmV6IiwiYSI6ImNrNDFzbHNmeTA0cWwzZW83eTY1MzZsOTcifQ.G3atMixx64nNOuaXXSPNnQ';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/danier-martinez/ck41svmr11j7l1cqlvd9th54h',
    scrollZoom: false
...
var showAlert = function showAlert(type, msg) {
  hideAlert();
  var markup = "\n    <div class=\"alert alert--".concat(type, "\">").concat(msg, "</div>");
...
var hideAlert = function hideAlert() {
  var markup = document.querySelector('.alert');
...
/*eslint-disable*/
var redirect = function redirect(page) {
  setTimeout(function () {
...
/*eslint-disable*/
var stripe = Stripe('pk_test_QE9S9qYP492dEKY1VMcuWBv900jbw8WNNL');
...
if (userPasswordForm) {
  userPasswordForm.addEventListener('submit', function _callee(e) {
    var passwordCurrent, password, passwordConfirm, btnSavePassword;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            btnSavePassword = document.querySelector('.save-password').textContent = 'Updating...';
            _context.next = 7;
